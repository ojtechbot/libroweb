...
import { Home, LogOut, Menu, Library, LayoutDashboard, Send, GitPullRequest } from "lucide-react";
import LibrarianProtectedRoute from "@/components/librarian/librarian-protected-route";
                           ...
                           <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    ...
                                    <Avatar className="h-8 w-8">
                                        ...
                                        <AvatarFallback>{getInitials(user.name || user.email || 'L')}</AvatarFallback>
                                    </Avatar>
                                    </Button>
                                </DropdownMenuTrigger>
